 ...
 * <pre>
 * Photo routines
 * Last Updated: $Date: 2015-05-29 18:05:48 -0400 (Fri, 29 May 2015) $
 * </pre>
 *
 * @author		$author$
...
class classes_member_photo
{
	...
	public function getEditorHtml( array $member )
	{
		...
		if ( ! IPSMember::canUploadPhoto( $member, TRUE ) )
 		...
 		/* Set up Gravatar */
		$gravatarUrl = $this->registry->output->isHTTPS ? 'https://secure.gravatar.com' : 'http://www.gravatar.com';
		$data['gravatar']['tag'] = "<img src='{$gravatarUrl}/avatar/" . md5( $member['pp_gravatar'] ) . "?s=100' alt='' />";

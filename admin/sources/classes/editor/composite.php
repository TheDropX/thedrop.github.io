 ...
 * Last Updated: $Date: 2015-08-03 11:51:51 -0400 (Mon, 03 Aug 2015) $
 * </pre>
 *
...
class classes_editor_composite
{
	...
	*/
	...
	public function process( $content )
	{
		...
		/* Mobile skin / app? */
		if ( $this->_canWeRte() !== true || $this->registry->output->getAsMobileSkin() || $_REQUEST['noCKEditor'] || $this->getRteEnabled() !== TRUE )
		{

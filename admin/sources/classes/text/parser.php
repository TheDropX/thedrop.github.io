...
class classes_text_parser
{
	...
	public function removeDisabledTags( $html )
	{
		...
		foreach( $tagArray as $tag )
		{
			...
			foreach( $matches as $val )
			{
				...
				// Leave emoticons from legacy versions alone.
				if ( stripos( $all, '<#EMO_DIR#>' ) !== false )
				{
					continue;
				}
	 ...
	 * @param	bool	If a URL is not allowed due to white/blacklist, the URL should be checked. See ticket 883140 & Line 1370 of classes_text_parser_bbcode

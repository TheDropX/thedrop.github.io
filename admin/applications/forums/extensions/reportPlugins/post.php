 ...
 * Last Updated: $LastChangedDate: 2015-06-15 20:02:43 -0400 (Mon, 15 Jun 2015) $
 * </pre>
 *
...
class post_plugin
{
	...
	public function processReport( $com_dat )
	{
		...
		else
		{
			...
			$rid		= $the_report['id'];
			$this->DB->update( 'rc_reports_index', array( 'date_updated' => time(), 'status' => $status['new'], 'seoname' => $data['title_seo'], 'seotemplate' => '', 'updated_by'	=> $this->memberData['member_id'] ), "id='{$rid}'" );
		}

...
class enhancements_members_mandrill
{
	...
	public function saveSettings()
	{
		...
		/* If they want to use Mandrill for SMTP too, update those settings */
		if ( ipsRegistry::$request['smtp'] )
		{
			$update['smtp_host']	= 'smtp.mandrillapp.com';
			$update['mail_method']	= 'smtp';
			$update['smtp_port']	= 587;
			$update['mail_wrap_brackets']	= 0;
			$update['smtp_user']	= ipsRegistry::$request['username'];
			$update['smtp_pass']	= ipsRegistry::$request['api_key'];
			$update['smtp_helo']	= 'HELO';
		}

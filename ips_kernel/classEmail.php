 ...
 * Last Updated: $Date: 2015-07-03 10:50:06 -0400 (Fri, 03 Jul 2015) $
 * </pre>
 *
...
class classEmail implements interfaceEmail
{
	...
	protected function _buildHeaders()
	{
		...
		if ( count($this->parts) > 0 )
		{
			if ( ! $this->html_email )
			{
				/* This needs to be an actual header, other needs to be body - #919118 */
...
//				$extra_headers[0]['notencode']		= "\n\nThis is a MIME encoded message.\n\n--".$this->boundry."\n";
		...
		else
		{
			...
			{
				/* This needs to be an actual header, other needs to be body - #919118 */
				$this->mail_headers['Content-Type'] = "multipart/alternative;\n\tboundary=\"".$this->boundry."\"";
		...
		{
			/* These must be set as the body - #919118 */
			$this->message .= $extra_headers_rfc;
